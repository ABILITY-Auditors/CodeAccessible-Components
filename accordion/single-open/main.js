...
let accordionGroup = document.getElementById('single-open-accordion-group');
...
function switchAccordion(event) {
    ...
    // all controllers
    let accordionControllers = document.querySelectorAll(".accordion-controller");
    ...
    // need to be hidden using ARIA-HIDDEN attribute
}